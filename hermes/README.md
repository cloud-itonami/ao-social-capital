...
| profile | description |
|---|---|
| `social-capital` | social-capital: propose-only bot for the individual data contribution social capital ledger. Measures hyakka claims, aozora records, yataverse lake, moyoshi set |
